...
describe.skip('InfoLabelService', () => {
  ...
  it('should return project info for index 0', () => {
    ...
    expect(result.summaryLine).toBe('Begin creating your DMP by identifying your project.');
  ...
  it('should return costs info for index 9', () => {
    ...
    expect(result.greeting).toBe('Step 5, Let’s elaborate on your storage, Firstname');
    expect(result.summaryLine).toBe(
  ...
  it('should return end info for index 10', () => {
    ...
    expect(result.greeting).toBe('On to Step 6, you’re halfway there, Firstname!');
    expect(result.summaryLine).toBe(
  ...
  it('should return project info for an invalid index', () => {
    ...
    expect(result.summaryLine).toBe('Elaborate on future access to your data. ');
  ...
  it('should return project info for an invalid index', () => {
    ...
    expect(result.summaryLine).toBe('Choose suitable repositories for your data.');
  ...
  it('should return project info for index greater than 10', () => {
    ...
    expect(result.summaryLine).toBe('Estimate the costs for data management in this project. ');
