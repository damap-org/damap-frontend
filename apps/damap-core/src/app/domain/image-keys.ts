...
export const THEME_IMAGE_DEFINITIONS: ThemeImageDefinition[] = [
  {
    ...
    defaultUrl: 'apps/damap-shell/src/assets/landing-page-background.png',
  ...
  },
  {
    ...
    defaultUrl: 'apps/damap-shell/src/assets/landing-page-graphic.png',
  ...
  },
  {
    ...
    defaultUrl: 'apps/damap-shell/src/assets/landing-page-logo.svg',
  ...
  },
  {
    key: IMAGE_KEYS.LOGO,
    label: 'Logo',
    defaultUrl: 'apps/damap-shell/src/assets/logo.svg',
  ...
  },
  {
    ...
    label: 'ORCID ID',
    defaultUrl: 'apps/damap-shell/src/assets/ORCIDiD_iconvector.svg',
  ...
  },
  {
    ...
    label: 'Favicon',
    defaultUrl: 'apps/damap-shell/src/assets/favicon.ico',
    recommendation: 'Recommended aspect ratio: 1:1',
    multitenancyLocked: false,
  },
];
