...
export const completeDmp: Dmp = {
  ...
  contributors: [mockContact, mockContributor1, mockContributor2],
  costs: [
    {
      currencyCode: 'EUR',
      customType: '',
...
export const noDataDmp: Dmp = {
  ...
  dataQuality: [
    DataQualityType.REPRESENTATION_WITH_CONTROLLED_VOCABULARIES,
    DataQualityType.DATA_ENTRY_VALIDATION,
  ],
  datasets: [closedDatasetMock, restrictedDatasetMock],
  documentation: 'documentation',
